        ...
        <div className="w-96">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <br />
              <input
                className="mb-5 focus:outline-none px-2 py-2 w-96"
                placeholder="Name"
                {...register("name", {
                  required: true,
                  minLength: 1,
              ...
              {errors.name && (
                <p className="text-rose-400">
                  Name min length 1 character and Name max length 20 character
                </p>
              )}
            </div>
            <div>
            ...
            <div>
              ...
              <br />
              <input
                className="focus:outline-none px-2 py-2 w-96"
                ...
                {...register("password", {
                  ...
                  pattern: {
                    ...
                    message:
                      "It must contain at least one uppercase, one lowercase and one numeric character one scpecial character.",
                  },
                })}
              />
              {errors.password && (
            ...
            <input
              className="btn mt-5 bg-orange-400 hover:bg-orange-400 text-white w-96"
              type="submit"
              value="SignUp"
            />
          </form>
